...
app.get('/vegetables/:id/edit', async (req, res) => {
    try {
        ...
        if(!foundVegetable){
            throw new error('No vegetables with that Id is in our database')
        } 
...
app.listen(PORT, () =>{
   console.log('app running on port 3000 because you are smoking HOTTT...')
})
