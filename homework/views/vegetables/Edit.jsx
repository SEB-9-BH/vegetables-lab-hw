...
function Edit (props) {
    const { name, _id, color, readyToEat } = props.vegetable
    return (
        <Layout vegetable={props.vegetable}>
            ...
            <a href="/vegetables">Go back to Index Page</a>
                <form action={`/vegetables/${_id}?_method=PUT`} method="POST">
                    ...
                    <br/>
                    Is Ready To Eat: {readyToEat? <input type="checkbox" name="readyToEat" defaultChecked />: <input type='checkbox' name="readyToEat"/>}
                    <br/>
